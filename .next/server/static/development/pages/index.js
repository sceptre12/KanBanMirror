...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  constructor(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "__socketListeners", () => {
  ...
  componentDidMount() {
    ...
    try {
      this.socket = socket_io_client__WEBPACK_IMPORTED_MODULE_3___default()(host);
      this.setState({
  ...
  render() {
    ...
    return __jsx(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_2___default.a, null, __jsx("title", null, "Smart Kan"), __jsx("meta", {
      name: "viewport",
    ...
    }, __jsx("h1", null, "Smart Kan"), hasConnectionEstablished ? __jsx(qrcode_react__WEBPACK_IMPORTED_MODULE_4___default.a, {
      value: host.toString(),
      size: 200
...
module.exports = __webpack_require__(/*! /Users/xavierthomas/webProjects/kanbanmirror/pages/index.js */"./pages/index.js");
